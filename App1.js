...
import { View, Text, TextInput, Image, StyleSheet, ScrollView, FlatList,
...
export default function App() {
  ...
  return (
    ...
    <View style={styles.container}>
      <TouchableWithoutFeedback onPress={() => console.log("test -> TouchableWithoutFeedback")}>
      <Image
        //source={LOGO}
        source={{uri: imgUrl}}
       ...
       <TouchableHighlight onPress={() => console.log("test -> TouchableHighlight")}>
        <Text style={{
          color: 'white',fontWeight: 'bold', padding: 2, marginBottom: 10, fontSize: 20}}
          >2i-Tech Paris-2</Text>
      </TouchableHighlight>
